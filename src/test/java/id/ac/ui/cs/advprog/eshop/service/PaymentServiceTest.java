...
class PaymentServiceTest {
    ...
    void testAddPaymentBankTransferSuccess() {
        Payment payment = new Payment("pay-001", "BANK_TRANSFER", bankTransferData);
    ...
    void testAddPaymentBankTransferRejected() {
        ...
        Payment payment = new Payment("pay-003", "BANK_TRANSFER", bankTransferData);
        doReturn(payment).when(paymentRepository).save(any(Payment.class));
    ...
    void testGetPaymentFound() {
        ...
        doReturn(payment).when(paymentRepository).findById("pay-007");

        Payment result = paymentService.getPayment("pay-007");

        assertEquals("pay-007", result.getId());
    }
    ...
    void testGetAllPayments() {
        Payment p1 = new Payment("pay-001", "BANK_TRANSFER", bankTransferData);
        Payment p2 = new Payment("pay-002", "VOUCHER", voucherData);
